...
export const SingleReview = ({
  ...
  return (
    <section className={styles.reviewcard}>
      <h2 id={styles.title} className={styles.gridItem}>
        {currentReview.title}
      </h2>
      <h3 id={styles.username} className={styles.gridItem}>
        {currentReview.owner}
      </h3>
      <p id={styles.timeOfPost} className={styles.gridItem}>
        {newTime}
      </p>
      <p id={styles.category} className={styles.gridItem}>
        Category: {currentReview.category}
      </p>
      <img
        src={currentReview.review_img_url}
        alt={`The game ${currentReview.title}`}
        className={styles.gridItem}
      ></img>

      <p id={styles.body} className={styles.gridItem}>
        {currentReview.review_body}{" "}
      </p>
      <br></br>
      <p id={styles.votes} className={styles.gridItem}>
        Review Votes: {currentReview.votes}
      </p>
